...
from PyQt5.QtWidgets import (
    ...
    QLabel, QLineEdit, QMessageBox, QTreeWidget, QTreeWidgetItem, QSplitter, QDialog
)
...
class PDFViewer(QWidget):
    ...
    def load_encrypted_files(self):
        """加载 encrypted_files 目录下的所有加密 PDF 文件"""
    ...
    def open_pdf(self, item):
        ...
        self.pdf_view.load(QUrl.fromLocalFile(os.path.abspath(tmp_pdf)))
